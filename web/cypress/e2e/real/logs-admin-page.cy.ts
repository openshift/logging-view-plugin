...
describe('Logs Page', () => {
  ...
  */
  ...
  it('query applicatioins logs', () => {
    ...
    cy.get('#expand.pf-v5-c-table__td.lv-plugin__table__expand.pf-v5-c-table__toggle').find('button').first().click();
    //cy.get('td.pf-v5-c-table__td.lv-plugin__table__expand').find('button').click();
